...
fileArray = ["ui_mainWindow.py", "ui_optionsWindow.py", "ui_infoWindow.py", "ui_editPersonWindow.py", "ui_worldBuildingWindow.py", "ui_addRelationWindow.py"];
...
const fullText = line1 + line2 + line3 + line4 + line5 + line6 + line7;
