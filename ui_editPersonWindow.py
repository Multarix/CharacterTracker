...
class Ui_editPersonWindow(object):
    def setupUi(self, editPersonWindow):
        ...
        self.name.setGeometry(QtCore.QRect(100, 30, 131, 21))
        self.name.setAcceptDrops(False)
        self.name.setToolTip("")
        self.name.setText("")
        self.name.setPlaceholderText("John")
        ...
        self.name_2 = QtWidgets.QLineEdit(editPersonWindow)
        self.name_2.setGeometry(QtCore.QRect(240, 30, 131, 21))
        self.name_2.setAcceptDrops(False)
        self.name_2.setToolTip("")
        self.name_2.setText("")
        self.name_2.setPlaceholderText("Smith")
        ...
        self.fullNameLabel_2.setBuddy(self.name)
    ...
    def retranslateUi(self, editPersonWindow):
        ...
        self.name_2.setWhatsThis(_translate("editPersonWindow", "<html><head/><body><p><br/></p></body></html>"))
