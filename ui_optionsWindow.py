...
class Ui_optionsWindow(object):
    def setupUi(self, optionsWindow):
        ...
        self.timelineLength_spin.setMaximum(99)
        ...
        self.timelineScale_spin = QtWidgets.QSpinBox(self.layoutWidget)
        self.timelineScale_spin.setMinimumSize(QtCore.QSize(100, 25))
        self.timelineScale_spin.setMaximumSize(QtCore.QSize(100, 25))
        self.timelineScale_spin.setSuffix("")
        self.timelineScale_spin.setMinimum(1)
        self.timelineScale_spin.setMaximum(99)
        self.timelineScale_spin.setProperty("value", 10)
        self.timelineScale_spin.setObjectName("timelineScale_spin")
        self.timelineScaleLayout.addWidget(self.timelineScale_spin)
        ...
        self.startYear_spin.setMaximum(9999)
        self.startYear_spin.setProperty("value", 1234)
    ...
    def retranslateUi(self, optionsWindow):
        ...
        self.timelineLength.setText(_translate("optionsWindow", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Total Years</span></p></body></html>"))
        self.timelineScale.setText(_translate("optionsWindow", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Months Per Year</span></p></body></html>"))
